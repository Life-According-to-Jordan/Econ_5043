...
```
#Make prop table to see probabilities
```{r}
...
#Add margins to see marginal probabilities and totals 
```{r}
...
#5
```{r}
ExpectedTT<-table(titanic$Survived, titanic$Pclass)
ExpectedTT
addmargins(ExpectedTT)
chisq.test(ExpectedTT)
